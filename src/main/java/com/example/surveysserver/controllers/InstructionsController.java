...
public class InstructionsController {
    @Autowired
    InstructorsRepository instructionsRepository;
    ...
    public int saveInstructors(@RequestBody List<Instructors> instructors){
        return instructionsRepository.save(instructors);
    }
